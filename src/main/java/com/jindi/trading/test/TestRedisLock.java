package com.jindi.trading.test;

import com.jindi.trading.TradingApplication;
...
public class TestRedisLock {
	...
	//@Autowired
	private final StringRedisTemplate stringRedisTemplate;//可以写很多类型的值

	@Autowired
	public  TestRedisLock(StringRedisTemplate stringRedisTemplate){
	...
	public void test(){
		//设置过期时间
		stringRedisTemplate.opsForValue().set("key1","value1",60, TimeUnit.DAYS);
	}
